...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Map<String, dynamic> _parseResponse(Map<String, dynamic> raw) {
    ...
    final rainChances = List<int>.from(
        (daily['precipitation_probability_max'] as List).map((v) => (v as num).toInt()));
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(PhosphorIcons.cloudSlash(), size: 48, color: Colors.grey),
      ...
      children: [
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(_weatherIcon(w['weather_code'] as int),
                    size: 56, color: Colors.orange),
                const SizedBox(height: 8),
                Text(_weatherLabel(w['weather_code'] as int),
                    style: const TextStyle(fontSize: 16, color: Colors.grey)),
                const SizedBox(height: 8),
                // Large current temperature
                Text(
                  '${(w['current_temp'] as double).toStringAsFixed(1)}°C',
                  style: const TextStyle(
                      fontSize: 52, fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 4),
                Text(
                  'High ${(w['temp_max'] as double).toStringAsFixed(0)}°  '
                  'Low ${(w['temp_min'] as double).toStringAsFixed(0)}°',
                ...
                Row(
                  ...
                  children: [
                    ...
                    _StatChip(
                        ...
                        label: 'Wind',
                        value: '${(w['wind_speed'] as double).toStringAsFixed(0)} km/h'),
                    _StatChip(
        ...
        ...forecast.map((day) => Card(
          ...
          child: ListTile(
            leading: Icon(_weatherIcon(day['code'] as int), color: Colors.green),
            ...
            trailing: Column(
              ...
              children: [
                Text('${(day['max'] as double).toStringAsFixed(0)}° / '
