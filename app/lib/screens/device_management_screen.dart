    ...
    return DoubleBackPressWrapper(
      child: ListView(
        ...
        children: [
            ...
            children: [
              if (!_editingName)
                ListTile(
                  ...
                  title: Text('Name', style: TextStyle(color: labelColor)),
                  subtitle: Text(
                    deviceName,
              ...
              ListTile(
                ...
                title: Text('Last Seen', style: TextStyle(color: labelColor)),
                subtitle: Text(
              ...
              ListTile(
                ...
                title: Text('Device ID', style: TextStyle(color: labelColor)),
                subtitle: Text(
          ...
          SettingsSection(
            title: 'Connectivity',
            leadingIcon: Icon(Icons.wifi_rounded, size: 20, color: labelColor),
            children: [
              ApiConnectivityTile(
